...
- Deux rendez-vous ne peuvent pas être donner pour un même vétérinaire.
- Le statut du rendez-vous doit être : Prévu, confirmé ou annulé .
...
- Un vétérinaire ne peut pas avoir deux rendez-vous en même temps.
- 
**Validations :**
...
Les principales entités métier du système sont les suivantes :
...
Relations :
- Un utilisateur peut être Administrateur, Réceptionniste, Vétérinaire ou Client.


### Propriétaire
Représente un client de la clinique.
...
### Animal
Représente un animal appartenant à un propriétaire.
...
### Vétérinaire
Représente un vétérinaire de la clinique.
...
Relations :
- Un vétérinaire possède plusieurs horaires.
- Un vétérinaire peut avoir plusieurs rendez-vous.


### RendezVous
Représente un rendez-vous entre un animal et un vétérinaire.
...
Relations :
- Un rendez-vous est associé à un animal.
- Un rendez-vous est associé à un vétérinaire.

### Horaire
Représente les disponibilités d’un vétérinaire.
...
Relations :
- Un horaire appartient à un vétérinaire.
